...
final class AddressPickerViewController: UIViewController, MKMapViewDelegate, UISearchBarDelegate {
    ...
    func focusOnMoscow() {
        let moscowCoordinates = CLLocationCoordinate2D(latitude: 43.02523, longitude: 44.66598) // Координаты Москвы
        ...
        let region = MKCoordinateRegion(center: moscowCoordinates, latitudinalMeters: regionRadius, longitudinalMeters: regionRadius)
...
//            }
            ...
            DispatchQueue.main.async {
                ...
                print(addressString)
                UserSettings.address = addressString
...
//    func includes(region: MKCoordinateRegion) -> Bool {
//        // Проверяем, содержится ли регион полностью внутри другого
//        let center = region.center
//        let northEast = CLLocationCoordinate2D(latitude: center.latitude + region.span.latitudeDelta / 2,
...
//                                               longitude: center.longitude - region.span.longitudeDelta / 2)
//        
//        return (northEast.latitude <= self.latitudeDelta / 2 &&
//                southWest.latitude >= -self.latitudeDelta / 2 &&
//                northEast.longitude <= self.longitudeDelta / 2 &&
//                southWest.longitude >= -self.longitudeDelta / 2)
//    }
//}
