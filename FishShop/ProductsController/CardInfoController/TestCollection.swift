...
//        ])
//        
//        cardsData = [.init(image: "salmon", price: "1.990 р", title: "Tasty salmon", prodType: .salmon, prodId: 1, prodCount: 0),
//                     .init(image: "dish", price: "1.990 р", title: "Grilled fish", prodType: .salmon, prodId: 2,prodCount: 0),
...
//        
//        print("RELOAD")
////        if cardsData[indexPath.row].isInBasket {
////            //cell.basketButtonAnimation()
////        }
//        
